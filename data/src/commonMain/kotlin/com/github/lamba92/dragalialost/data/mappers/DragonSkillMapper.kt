    ...
    override fun fromRemoteSingle(remote: Pair<SkillJSON, Triple<ImageInfoJSON, ImageInfoJSON, ImageInfoJSON>>) =
        with(remote) {
            DragonSkill(
                ...
                first.Sp.toLong(),
                second.first.url,
                SkillLevelData(SkillLevel.ONE, DragaliaEntity.SKILL_LVL1_MIGHT, first.Description1),
                SkillLevelData(SkillLevel.TWO, DragaliaEntity.SKILL_LVL2_MIGHT, first.Description2)
            )
        }
