...
class AdventurerSkillMapper :
    ...
    override fun fromRemoteSingle(remote: Pair<SkillJSON, Triple<ImageInfoJSON, ImageInfoJSON, ImageInfoJSON>>) =
        ...
        AdventurerSkill(
            ...
            first.Sp.toLong(),
            second.first.url,
            SkillLevelData(SkillLevel.ONE, SKILL_LVL1_MIGHT, first.Description1.sanitize()),
            SkillLevelData(SkillLevel.TWO, SKILL_LVL2_MIGHT, first.Description2.sanitize()),
            if (first.HideLevel3 == "Yes") null else SkillLevelData(
                SkillLevel.THREE,
                SKILL_LVL3_MIGHT,
